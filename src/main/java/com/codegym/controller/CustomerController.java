...
public class CustomerController {
    ...
    public String save(Customer customer, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("success", "Save customer thanh cong");
        return "redirect:/";
    }
    ...
    public String update(Customer customer, RedirectAttributes redirectAttributes) {
        ...
        redirectAttributes.addFlashAttribute("success", "Edit thanh cong");
        return "redirect:/";
    }
    ...
    public String showview(@PathVariable int id, Model model) {
        Object o = customerService.findById(id);
